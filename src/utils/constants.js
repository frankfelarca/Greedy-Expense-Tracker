...
export const CAT_LABELS = { meals: 'Meals', alcohol: 'Drinks', fuel: 'Fuel', toll: 'Toll', parking: 'Parking', entrance: 'Entrance', others: 'Others' };
...
export const CAT_ICONS = { hotel: '\u{1F3E8}', meals: '\u{1F37D}', alcohol: '\u{1F37B}', fuel: '\u{26FD}', toll: '\u{1F6E3}', parking: '\u{1F17F}', entrance: '\u{1F3AB}', others: '\u{1F4E6}' };
