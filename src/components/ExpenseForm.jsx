...
export default function ExpenseForm({ currentUser, onClose }) {
  ...
  }, [form, submitting, currentUser, dispatch, syncConfig, makeBlank, isExpenseLocked, onClose]);
  ...
  return (
    ...
    >
      ...
      >
        <div className="expense-drawer-handle" />
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div>
              ...
              {isExpenseLocked && (
                <div style={{ fontSize: '0.78rem', color: 'var(--accent1)', marginTop: 2 }}>
                  {'\u{1F512}'} Locked for settlement
                </div>
              )}
              {!isExpenseLocked && lockCountdown && (
                <div style={{ fontSize: '0.78rem', color: 'var(--accent2)', marginTop: 2 }}>
                  {'\u{1F552}'} Locks in {lockCountdown}
                </div>
              )}
            </div>
          </div>
                ...
                <div style={{ marginTop: 6 }}>
                  <div style={{
                    ...
                    <div style={{
                      ...
                      background: 'var(--gradient-primary)', transition: 'width 0.2s',
                    }} />
                  </div>
                ...
                return (
                  <motion.label
                    ...
                    style={{
                      ...
                      background: selected ? 'rgba(129,140,248,0.12)' : 'var(--surface3)',
                      ...
                      boxShadow: selected ? '0 0 12px rgba(129,140,248,0.15)' : 'none',
                    }}
                  >
                    <span style={{
